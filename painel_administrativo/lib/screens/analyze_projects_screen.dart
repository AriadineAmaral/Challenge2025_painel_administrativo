        ...
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                "Analisar projetos",
                style: AppStyles.kufam(30,Colors.black, AppStyles.bold),
              ),
            ),
          ),
  ...
  child: Column(
    ...
    children: [
      ...
      Padding(
        ...
        child: Text(
          "Lista de projetos",
          style: AppStyles.kufam(16, Colors.black, AppStyles.bold),
        ),
      ),
          Checkbox(
            value: analysis,
          ...
          Padding(
           ...
           child: Button(
              ...
              textStyle: AppStyles.akatab(13, Colors.black, AppStyles.semiBold),
              width: 88,
              height: 32,
              elevation: 4,
